        ...
        <div class="box box-solid box-primary">
          ...
          <div class="box-body table-responsive no-padding">
            <table class="table table-hover" style="margin-left: 5%; width: 90%">
              ...
              <tbody id="resultados">
                <?php
                    $query_cliente = mysqli_query($conexao, "select id_cliente, cpf_cliente, nome_cliente, telefone_cliente, status_cliente, email_cliente
                    from cliente");
                    ...
                    if(mysqli_num_rows($query_cliente) < 1){
                      ...
                      while($lista_cliente = mysqli_fetch_array( $query_cliente)) {
                      echo "
                        <tr>
